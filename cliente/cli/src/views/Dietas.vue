...
<div class="container">
    ...
    <form @submit.prevent="editarDieta(dietaEditar)" v-if="editar">
        ...
        <input type="text" class="form-control my-2" placeholder="Nombre" v-model="dietaEditar.nombreDieta">
        <input type="text" class="form-control my-2" placeholder="Descripcion" v-model="dietaEditar.descripcionDieta">
    ...
    <form @submit.prevent="agregarDieta()" v-if="!editar">
        ...
        <input type="text" class="form-control my-2" placeholder="Nombre" v-model="dieta.nombreDieta">
        <input type="text" class="form-control my-2" placeholder="Descripcion" v-model="dieta.descripcionDieta">
    ...
    <table class="table">
        ...
        <tbody>
            <tr v-for="(item, index) in dietas" :key="index">
                ...
                <td>
                    <b-button class="btn-danger mx-2" @click="eliminarDieta(item._id)">Eliminar</b-button>
...
export default {
    ...
    methods: {
        ...
        agregarDieta(){
            ...
            this.axios.post('/new-dieta',this.dieta)
            .then(res=>{
        ...
        eliminarDieta(id){
            ...
            this.axios.delete(`/dieta/${id}`)
            .then(res=>{

                const index = this.dietas.findIndex(item=> item._id===res.data._id);
        ...
        editarDieta(item){
            ...
            this.axios.put(`/dieta/${item._id}`, item)
            .then(res=>{
